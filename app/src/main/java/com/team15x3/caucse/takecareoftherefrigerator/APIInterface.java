...
public interface APIInterface {
    ...
    Call<MultipleResources> doGetListResources(@Query("foodType")String appkey, @Query("searchField") String searchField, @Query("searchValue") String searchValue,
    ...
    @GET("foodinfo/1.0/foods/?")
    Call<FoodList> doGetFood(@Query("foodType")String appkey, @Query("searchField") String searchField, @Query("searchValue") String searchValue,
                                               @Query("addSearchField") String addSearchField, @Query("addSearchValue")String addSearchValue,
                                               @Query("exSearchField")String exSearchField, @Query("exSearchValue")String exSearchValue,
                                               @Query("offset")Number offset, @Query("limit")Number limit);
