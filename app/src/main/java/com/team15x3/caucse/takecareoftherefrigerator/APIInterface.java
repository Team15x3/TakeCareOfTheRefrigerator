...
public interface APIInterface {
    ...
    Call<EatSightAPI> getFoodInformation(@Query("foodType")String foodType, @Query("searchField") String searchField, @Query("searchValue") String searchValue,
    ...
    Call<Food> getDetailFoodInformation(@Path("foodId") String foodID);
}
